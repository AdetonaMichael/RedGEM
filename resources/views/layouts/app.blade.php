                    ...
                    <div class="md:flex hidden items-center space-x-3">
                        ...
                        <div class="dropdown inline-block relative">
                            ...
                            <ul class="dropdown-menu absolute hidden bg-white text-gray-700 pt-1">
                              <li class=""><a class="rounded-t bg-gray-200 hover:text-red-600 hover:bg-gray-400 py-4 px-6 block whitespace-no-wrap" href="#">RedGEM Token</a></li>
                              <li class=""><a class="bg-gray-200 hover:bg-gray-400 hover:text-red-600 py-4 px-6 block whitespace-no-wrap" href="#">Red Tokenomics</a></li>
