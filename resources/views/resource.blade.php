...
<div class="content">
    ...
    <div class="becomeus block md:flex justify-center">
        <div class="thetext items-justify-center m-5 p-5 relative top-11">
            <div class="flex items-center justify-between w-full my-8 pl-4 sm:pr-4">
                <div class="mr-6 md:mt-20 md:text-2xl">
                  <h2 class="text-4xl md:text-4xl font-semibold tracking-tight leading-7 md:leading-10 mb-1 truncate">Browse Resource</h2>
    ...
    <div class="grid mt-8  gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2 mb-5">
                ...
                <div class="flex-none lg:flex">
                    ...
                    <div class="flex-auto ml-3 justify-evenly py-2">
                        <div class="flex flex-wrap ">
                            ...
                            <h2 class="flex-auto text-lg font-medium">Traverse Computation Software</h2>
                        </div>
                        <p class="mt-3"></p>
                        ...
                        <div class="flex space-x-3 text-sm font-medium">
                            <div class="flex-auto flex space-x-3">
                                <button
                                    class="mb-2 md:mb-0 bg-white px-5 py-2 shadow-sm tracking-wider border focus:outline-none text-gray-600 rounded-full hover:bg-gray-100 inline-flex items-center space-x-2 ">
                            ...
                            <button
                                ...
                                type="button" aria-label="like">Download</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="flex flex-col ">
            <div class="bg-white shadow-md  rounded-3xl p-4">
                <div class="flex-none lg:flex">
                    <div class=" h-full w-full lg:h-48 lg:w-48   lg:mb-0 mb-3">
                        <img src="images\60815e99549d0-Quantum Madness From this side.png"
                            alt="Just a flower" class=" w-full  object-scale-down lg:object-cover  lg:h-48 rounded-2xl">
                    </div>
                    <div class="flex-auto ml-3 justify-evenly py-2">
                        <div class="flex flex-wrap ">
                            ...
                            <h2 class="flex-auto text-lg font-medium">Leveling Software</h2>
                        </div>
                        <p class="mt-3"></p>
                        <div class="flex py-4  text-sm text-gray-600">
                            <div class="flex-1 inline-flex items-center">
                        ...
                        <div class="flex space-x-3 text-sm font-medium">
                            ...
                            <button
                                class="mb-2 md:mb-0 bg-gray-900 px-5 py-2 shadow-sm tracking-wider text-white rounded-full focus:outline-none hover:bg-gray-800"
                                type="button" aria-label="like">Download</button>
                        </div>
                    </div>
                </div>
