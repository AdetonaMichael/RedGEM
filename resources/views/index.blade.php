...
<div class="mx-0 min-h-4/5 text-center text-gray-900 justify-around md:grid md:grid-cols-3 p-10 ">
    ...
    <div
        ...
        <h2 class="text-2xl font-bold border-red-700 border-b-4 pb-2 ">ANTICIPATE TIER 2</h2>
    ...
    <div
        ...
        <i class="fa fa-address-card fa-4x text-red-700 border-red-700  p-5 borde-dashed hover:animate-pulse border-8 rounded-full m-5 "
            aria-hidden="true"></i>
        <h2 class="text-2xl font-bold border-red-700 border-b-4 pb-2">ANTICIPATE TIER 3</h2>
...
<div class="becomeus block md:flex justify-center">
    <div class="thetext items-justify-center m-5 p-5 relative top-11 space-y-5">
        ...
        <p class="font-semibold font-sans leading-10 text-xl">
            ...
            THE POWER TO MINT (CREATE) MONEY IS SUPER COOL, WORK & RETIRE WITHIN THE NEXT 5 YEARS!
            JOIN TO LAUNCH THE NEXT BIGGEST ALT-COIN OF THE CENTURY!
            NO GO (FIT) CRY FOR TOMORROW
            1). BUY THE FUTURE TODAY 2). GET RedGEM Token FOR FREE
            3). EAT FOR FREE, GET FREE $100 RedGEM Token

        </p>
        <div class="socials block md:flex justify-around">
            <a href="/about"
                class="text-center justify-center rounded-full px-8 py-4 hover:bg-red-900 bg-red-700 text-white font-sans ">More
                About Us</a>
        </div>
    </div>
    <div class=" m-5 p-5">
        <div class="svgimage ">
            <svg id="271e5882-3c8d-41ed-8a0a-1cb2b4d0cbc1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1137.68 859.71">
                <defs>
                    <linearGradient id="1d1d90cb-e8d6-4c10-b901-192027040f7e" x1="512.79" y1="730.45" x2="512.79"
                        y2="139.36" gradientUnits="userSpaceOnUse">
                        <stop offset="0" stop-color="gray" stop-opacity="0.25" />
                        <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
                        <stop offset="1" stop-color="gray" stop-opacity="0.1" />
                    </linearGradient>
                    <linearGradient id="8425757a-56ab-41b8-890b-c9acfe5ccb1b" x1="703.39" y1="781.93" x2="703.39"
                        y2="171.12" xlink:href="#1d1d90cb-e8d6-4c10-b901-192027040f7e" />
                    <linearGradient id="422858ff-741c-491e-b83f-4f975ae951a6" x1="876.05" y1="827.31" x2="876.05"
                        y2="239.74" xlink:href="#1d1d90cb-e8d6-4c10-b901-192027040f7e" />
                    <linearGradient id="cb632b7f-b2f8-40b2-b1bc-4aa48a1a2180" x1="479.8" y1="818.68" x2="479.8"
                        y2="229.88" gradientTransform="matrix(-1, 0, 0, 1, 828.87, 0)"
                        xlink:href="#1d1d90cb-e8d6-4c10-b901-192027040f7e" />
                    <linearGradient id="9b8149d4-8e0d-43dc-bd85-6bf0bb4ef8aa" x1="561.7" y1="875.44" x2="561.7"
                        y2="737.82" xlink:href="#1d1d90cb-e8d6-4c10-b901-192027040f7e" />
                </defs>
                ...
                <path
                    ...
                    transform="translate(-31.16 -20.14)" fill="#a8001b" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-31.16 -20.14)" fill="#a8001b" opacity="0.1" />
                <ellipse cx="664.34" cy="749.94" rx="75.23" ry="16.89" fill="#a8001b" opacity="0.1" />
                <ellipse cx="839.15" cy="803.58" rx="135.72" ry="11.14" fill="#a8001b" opacity="0.1" />
                <ellipse cx="294.22" cy="786.69" rx="135.72" ry="16.89" fill="#a8001b" opacity="0.1" />
                <ellipse cx="501.15" cy="702.14" rx="102.12" ry="16.89" fill="#a8001b" opacity="0.1" />
                <ellipse cx="529.66" cy="842.82" rx="81.75" ry="16.89" fill="#a8001b" opacity="0.1" />
                <path
                ...
                <path
                    ...
                    transform="translate(-31.16 -20.14)" fill="#a8001b" />
                ...
                <ellipse cx="527.78" cy="862.49" rx="2.31" ry="3.83"
                    transform="matrix(0.87, -0.5, 0.5, 0.87, -391.69, 359.3)" fill="#a8001b" />
                ...
                <ellipse cx="192.6" cy="716.06" rx="26.93" ry="4.55" fill="#a8001b" opacity="0.1" />
                <ellipse cx="86.51" cy="780.59" rx="26.93" ry="4.55" fill="#a8001b" opacity="0.1" />
                <ellipse cx="58.47" cy="722.86" rx="40.21" ry="6.8" fill="#a8001b" />
                <path
                    ...
                    transform="translate(-31.16 -20.14)" fill="#a8001b" />
                <ellipse cx="1029.83" cy="754.12" rx="26.93" ry="4.55" fill="#a8001b" opacity="0.1" />
                <path
...
<div class="award-holder rounded md:mx-20 my-10 bg-red-200 md: shadow-lg text-center p-10">
    <p class="text-4xl text-center justify-center font-extrabold text-red-700 my-10">Award And Recognition</p>
